...
#
# Generated by export_simulation on Fri Aug 21 16:17:32 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './design_ocr.sh' script.

./design_ocr.sh -reset_run
...
./design_ocr.sh -noclean_files

For more information on the script, please type './design_ocr.sh -help'.
