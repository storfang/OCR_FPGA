...
HD_PWD='G:/studia/fpga/project_sdup_ocr/OCR_FPGA/OCR_FPGA.runs/design_ocr_neural_network_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_ocr_neural_network_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_ocr_neural_network_0_0.tcl
